...
void menu()
{
    ...
    std::ofstream d;
    f.close();
    Inheritor_ССountry_second firstcountry1("Страна1", 143, 45745656, 47342362, 1, 22062012, 0);
    dir.add_el(firstcountry1);
    Inheritor_ССountry_second firstcountry2("Страна2", 156, 38567454, 68457458, 1, 13012016, 1);
    dir.add_el(firstcountry2);
    Inheritor_ССountry_second firstcountry3("Страна3", 167, 46357625, 98686453, 1, 31102007, 0);
    dir.add_el(firstcountry3);
    Inheritor_ССountry_second firstcountry4("Страна4", 179, 78567583, 68457458, 1, 27072000, 0);
    ...
    while (n != 9)
    {
        ...
        if (n == 1)
        {
            Inheritor_ССountry_second firstcountry5("Страна5", 323, 93645665, 78767464, 1, 24112001, 1);
