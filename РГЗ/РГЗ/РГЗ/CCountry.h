...
public:
    ...
    CCountry(const std::string&, const int&, const int&, const int&, const bool&, const int&);
    ~CCountry();
...
public:
    ...
    Inheritor_ÑÑountry(const std::string&, const int&, const int&, const int&, const bool&, const int&, const bool&);
    ~Inheritor_ÑÑountry();
...
public:
    ...
    Inheritor_ÑÑountry_second(const std::string&, const int&, const int&, const int&, const bool&, const int&, const bool&);
    ~Inheritor_ÑÑountry_second();
    virtual std::string getInfo() const final;
