...
{
	std::stringstream ss;
	ss << "_" << countries[index]->getTitle() << "_ " << countries[index]->getNumber_of_cities() << " " << countries[index]->getPopulation() << " " << countries[index]->getArea() << " " << countries[index]->getPlace_of_birth_citizen() << " " << countries[index]->getBirthday_citizen() << " " << countries[index]->getInfo() << " " << countries[index]->getKol_Nationality();
	return ss.str();
}
