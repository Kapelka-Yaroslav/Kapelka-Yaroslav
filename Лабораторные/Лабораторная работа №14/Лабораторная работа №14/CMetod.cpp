...
void CMetod::find_to_str_by_file(const std::string str)
{
	if (check_str(str))
	{
		...
		if (check == 1)
		{
			bool Monarchy;
			s >> Monarchy;
			Inheritor_ÑÑountry firstcountry(Title, Number_of_cities, Population, Area, Place_of_birth_citizen, Birthday_citizen, Unical_index, Monarchy);
			add_el(firstcountry);
		}
		else
		{
			...
			Inheritor_ÑÑountry_second secondcountry(Title, Number_of_cities, Population, Area, Place_of_birth_citizen, Birthday_citizen, Unical_index, Gross_domestic_product);
...
void count_place_of_birth_citizen::operator()(CCountry Country)
{
	if (Country.getPlace_of_birth_citizen() == true)
	{
		count++;
	}
}
void count_birthday_citizen::operator()(CCountry Country)
{
	if (Country.getBirthday_citizen() == 64)
	{
		count++;
	}
}
...
{
	if (Country.getBirthday_citizen() == true)
	{
		std::cout << Country << "\n";
	}
}
void ccount_place_of_birth_citizen::operator()(std::pair<int, CCountry> p)
{
	if (p.second.getPlace_of_birth_citizen() == true)
	{
		count++;
	}
}
void ccount_birthday_citizen::operator()(std::pair<int, CCountry> p)
{
	if (p.second.getBirthday_citizen() == true)
	{
		count++;
	}
}
...
bool sort_by::operator()(CCountry& Country1, CCountry& Country2) 
{
	if (type == 1)
	{
	...
	{
		return Country1.getNumber_of_cities() > Country2.getNumber_of_cities();
	}
	else if (type == 3)
	{
	...
	{
		return Country1.getUnical_index() > Country2.getUnical_index();
	}
	else if (type == 6)
	{
		return Country1.getPlace_of_birth_citizen() < Country2.getPlace_of_birth_citizen();
	}
	else if (type == 7) 
	{
		return Country1.getBirthday_citizen() < Country2.getBirthday_citizen();
	}
	else if (type == 8)
	{
		return Country1.getTitle() < Country2.getTitle();
